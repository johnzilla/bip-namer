...
// Function to get a random word from the BIP-39 wordlist
...
// Function to generate a military-style operation name
...
// Function to update the displayed name with animation
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    generateButton.addEventListener('click', updateProjectName);
    
    // Add keyboard support (Enter or Space to generate)
    ...
    // Optional: Add support for pressing 'G' anywhere on the page to generate
...
// Function to set up sharing button event listeners
function setupSharingButtons() {
    ...
    shareButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            shareProjectName(platform, projectName);
        });
    });
}
...
function shareProjectName(platform, projectName) {
    ...
    switch(platform) {
        ...
        case 'instagram':
            ...
            showNotification('Project name copied! Paste it in your Instagram story or post.');
            break;
            
        case 'linkedin':
            const linkedinUrl = `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(url)}&title=${encodeURIComponent('BIP Namer - Project Name Generator')}&summary=${encodeURIComponent(text)}`;
